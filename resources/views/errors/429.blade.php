...
<body class="h-screen overflow-hidden flex items-center justify-center" style="background: #edf2f7;">
    <div
        ...
        <div class="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
            <p class="text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider text-gray-300">429</p>
            <p class="text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider text-gray-300 mt-2">Too Many Requests</p>
            <p class="text-lg md:text-xl lg:text-2xl text-gray-500 my-12">You've made too many requests in a short time. Please wait a moment and try again.</p>
            <a href="{{ route('index') }}"
