...
<head>
    ...
    <title>@yield('title', 'SignUp')</title>
    <link rel="icon" href="{{ asset('favicon.ico') }}">
    <link href="{{ asset('dashboard/style.css') }}" rel="stylesheet">
</head>

<body x-data="{ page: 'signup', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }" x-init="darkMode = JSON.parse(localStorage.getItem('darkMode'));
                    ...
                    <div>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="space-y-5">
                                ...
                                <div class="sm:col-span-1">
                                    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                        Your Surname<span class="text-error-500">*</span>
                                    </label>
                                    <input type="text" id="surname" name="surname" value="{{ old('surname') }}"
                                        required autocomplete="surname" autofocus placeholder="Enter your surname"
                                        class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                                    @error('surname')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                        ...
                                        <span @click="showPassword = !showPassword"
                                            ...
                                            <svg x-show="!showPassword" class="fill-current" width="20"
                                                ...
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M10 4C5 4 1 10 1 10s4 6 9 6 9-6 9-6-4-6-9-6zm0 10a4 4 0 110-8 4 4 0 010 8z"
                                                    fill="#98A2B3" />
                                            </svg>
                                            <!-- Eye Slash Icon (Gösteriliyken) -->
                                            <svg x-show="showPassword" class="fill-current" width="20"
                                                height="20" viewBox="0 0 20 20" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M10 4c5 0 9 6 9 6s-4 6-9 6-9-6-9-6 4-6 9-6zm0 10a4 4 0 110-8 4 4 0 010 8zM3 3l14 14"
                                ...
                                <div>
                                    <div>
                                        ...
                                        <label for="terms"
                                            ...
                                            <a href="#"
                                                class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Terms &
                                                Conditions</a>
                                            and
                                            <a href="#"
                                                class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Privacy
                                                Policy</a>.
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="mt-5">
                            ...
                            <div class="text-center text-sm text-gray-600 dark:text-gray-400">
                                Already have an account? <a href="{{ route('login') }}"
                                    class="text-brand-500 hover:text-brand-600">Sign In</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="relative items-center hidden w-full h-full bg-brand-950 dark:bg-white/5 lg:grid lg:w-1/2">
                <div class="flex items-center justify-center z-1">
                    ...
                    <div class="absolute right-0 top-0 -z-1 w-full max-w-[250px] xl:max-w-[450px]">
                        <img src="{{ asset('dashboard/src/images/shape/grid-01.svg') }}" alt="grid" />
                    </div>
                    ...
                    <div class="flex flex-col items-center max-w-xs">
                        <a href="{{ route('dashboard.index') }}" class="block mb-4">
                            <img src="{{ asset('dashboard/src/images/logo/auth-logo.svg') }}" alt="Logo" />
                        </a>
                        <p class="text-center text-gray-400 dark:text-white/60">
                            GitHub: <a href="https://github.com/malisahin89">@MaliSahin89</a>
                        </p>
                    </div>
                </div>
            </div>
