...
<head>
    ...
    <title>@yield('title', 'Two Step Verification')</title>
    <link rel="icon" href="{{ asset('favicon.ico') }}">
    <link href="{{ asset('dashboard/style.css') }}" rel="stylesheet">
</head>

<body x-data="{ page: 'verification', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }" x-init="darkMode = JSON.parse(localStorage.getItem('darkMode'));
                ...
                <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
                    <div class="mb-5 sm:mb-8">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            A verification code has been sent to your account mail address.
                        </p>
                    </div>
                    <div>
                        <form>
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <div class="flex gap-2 sm:gap-4" id="otp-container">
                                        <input type="sixdigitcode" id="sixdigitcode" name="sixdigitcode"
                                            placeholder="Type six digit code."
