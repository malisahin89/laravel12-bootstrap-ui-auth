...
<head>
    ...
    <title>@yield('title', 'Forgot Your Password')</title>
    <link rel="icon" href="{{ asset('favicon.ico') }}">
    <link href="{{ asset('dashboard/style.css') }}" rel="stylesheet">
</head>

<body x-data="{ page: 'resetpass', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }" x-init="darkMode = JSON.parse(localStorage.getItem('darkMode'));
                    ...
                    <div>
                        ...
                        <div class="mt-5">
                            <p class="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                                <a href="#" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Return
                                    Login Page</a>
                            </p>
                        </div>
                    </div>
